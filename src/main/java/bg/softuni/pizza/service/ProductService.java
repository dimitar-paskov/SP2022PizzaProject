...
public class ProductService {
	...
	public void initProducts() {
		if (this.productRepository.count() == 0) {
			...
			List<IngredientEntity> ingredients = margarita.getIngredients();
			...
			margarita.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437651/projectPizza/pizzas/margarita_q91th6.png");
			...
			riveroni.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437651/projectPizza/pizzas/riveroni_ljomuj.png");
			...
			chickenita.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437650/projectPizza/pizzas/chickenita_bayiu8.png");
			...
			carbonara.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437650/projectPizza/pizzas/carbonara_v41r5i.png");
			...
			peperoni.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437651/projectPizza/pizzas/peperoni_boimmt.png");
			...
			italiana.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437650/projectPizza/pizzas/italiana_t8ubpi.png");
			...
			ingredients.add(ingredientRepository.findByName("freshTomatoes").get());
			ingredients.add(ingredientRepository.findByName("mushrooms").get());
			gardenClassic.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437650/projectPizza/pizzas/gardenClassik_aabf3u.png");
			gardenClassic.setPrice(BigDecimal.valueOf(16.00));
			gardenClassic.setName("garden");
			...
			hawai.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659437650/projectPizza/pizzas/hawai_w8yhvl.png");
			...
			pastaCarbonara.setName("Carbonara");
			...
			pastaNapolitana.setName("Napolitana");
			...
			pastaPeperoni.setName("Peperoni");
			...
			pastaMacAndCheese.setName("MacAndCheese");
			...
			ingredients.add(ingredientRepository.findByName("freshTomatoes").get());
			ingredients.add(ingredientRepository.findByName("olives").get());
			saladTricolore.setImageUrl(
					"https://res.cloudinary.com/dofeaskyi/image/upload/v1659456843/projectPizza/salad/salad_tricolore_nv4wdq.png");
			saladTricolore.setPrice(BigDecimal.valueOf(16.00));
			saladTricolore.setName("Tricolore");
	...
	public List<ProductView> findAllPizzas() {
		...
		return productRepository.findAllByCategory(ProductCategoryEnum.PIZZA).stream().map(this::map).toList();
	...
	public List<ProductView> findAllPasta() {
		...
		return productRepository.findAllByCategory(ProductCategoryEnum.PASTA).stream().map(this::map).toList();
	}

	public List<ProductView> findAllSalads() {

		return productRepository.findAllByCategory(ProductCategoryEnum.SALAD).stream().map(this::map).toList();
	}
